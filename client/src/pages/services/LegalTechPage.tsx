    ...
    <div className="py-16 space-y-16">
      ...
      <section className="container mx-auto px-4">
        <div className="bg-black/20 backdrop-blur-md border border-white/20 rounded-2xl p-8 md:p-12 text-center">
          ...
          <h1 className="text-4xl font-bold font-inter mb-4 text-white">Legal Firm Automation</h1>
      ...
      <div className="container mx-auto px-4">
        <div className="bg-black/20 backdrop-blur-md border border-white/20 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold font-inter mb-4 text-white">Focus on Billable Hours, Not Paperwork</h2>
          ...
          {/* Key Features */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold font-inter text-center mb-8 text-white">Specialized Legal Tech Services</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-file-signature text-2xl text-secondary"></i>
                </div>
                <h4 className="font-bold mb-2 text-white">Automated Client Intake</h4>
                <p className="text-sm text-gray-400">Seamlessly capture client data, generate engagement letters, and create case files in your system without manual entry.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-file-alt text-2xl text-secondary"></i>
                </div>
                <h4 className="font-bold mb-2 text-white">Intelligent Document Management</h4>
                <p className="text-sm text-gray-400">Automatically generate, file, and share case documents, ensuring consistency and compliance across your firm.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-calendar-check text-2xl text-secondary"></i>
                </div>
                <h4 className="font-bold mb-2 text-white">Case Workflow Automation</h4>
                <p className="text-sm text-gray-400">Create automated workflows for deadlines, client communication, and billing reminders to keep every case on track.</p>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4">
        <div className="bg-black/20 backdrop-blur-md border border-white/20 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl font-bold font-inter mb-4 text-white">Modernize Your Law Practice</h2>
