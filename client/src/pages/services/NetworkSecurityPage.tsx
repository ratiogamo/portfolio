...
const NetworkSecurityPage: React.FC = () => {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="bg-blue-500/5 py-20">
        <div className="container mx-auto px-4 text-center">
          <i className="fas fa-shield-alt text-4xl text-blue-500 mb-4"></i>
          <h1 className="text-4xl font-bold font-inter mb-4">Network Security & Infrastructure</h1>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold font-inter mb-4">Your First Line of Defense</h2>
          ...
          {/* Key Features */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold font-inter text-center mb-8">Our Security Services</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-fire-alt text-2xl text-blue-500"></i>
                </div>
                <h4 className="font-bold mb-2">Firewall & Gateway Security</h4>
                <p className="text-sm text-gray-600">Configuration and management of next-generation firewalls to control network traffic and block malicious activity.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-crosshairs text-2xl text-blue-500"></i>
                </div>
                <h4 className="font-bold mb-2">Threat Monitoring & Response</h4>
                <p className="text-sm text-gray-600">24/7 monitoring of your network for suspicious activity, with rapid response protocols to neutralize threats.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <i className="fas fa-network-wired text-2xl text-blue-500"></i>
                </div>
                <h4 className="font-bold mb-2">Infrastructure Optimization</h4>
                <p className="text-sm text-gray-600">Design and implementation of secure, scalable, and high-performance network infrastructure for your office.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold font-inter mb-4">Secure Your Business Today</h2>
