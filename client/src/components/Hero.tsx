      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <h1 className="text-4xl md:text-5xl font-bold font-inter mt-4 leading-tight">
            Automation Expert with <span className="text-primary">{profile?.totalJobs}+ Projects</span>
          </h1>
          <p className="mt-4 text-lg text-gray-600 max-w-md">
            Specializing in business workflow automation using Make.com, Zapier, n8n, and AI integration - delivering 12,000+ hours saved annually for clients.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-medium">Top-Rated Expert</span>
            </div>
            <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 font-medium">{profile?.availability}</span>
            </div>
          </div>
        </div>
